//This is the cards you see on the products or categories page, that contains the img, item, favorite star etc.
...
const ProductCard = ({ item, setSearchText }: Props) => {
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-1 overflow-hidden hover:border-black duration-200">
      <div className="w-full h-60 relative p-2 group cursor-pointer">
        <span
          onClick={open}
      ...
      <Transition appear show={isOpen}>  {/* You see the below when clicking on save x% on top left of image */}
        <Dialog
          as="div"
            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <DialogPanel className="w-full max-w-md rounded-xl bg-black backdrop-blur-2xl z-50 p-6">
                  ...
                  >
                    Hurry up!  {/* You see this when clicking on save x% on top left of image */}
                  </DialogTitle>
